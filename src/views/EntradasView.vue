...
const imagenEntrada = computed(() => {
 if (tipoEntrada.value === 'abono completo') return '/COMPLETO.png'
 if (tipoEntrada.value === '1 día') return '/1DIA.png'
 if (tipoEntrada.value === '2 días') return '/2DIA.png'
 return ''
})
...
<template>
 ...
 <div
 v-if="mostrarCompra"
 class="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 mt-15 overflow-y-auto"
 >
 <div
 :class="[
 'w-full max-w-2xl p-8 relative max-h-[calc(100vh-2rem)] overflow-y-auto',
 compraCompletada ? 'bg-[#fff3d7]' : 'bg-[#fff3d7]'
 ]"
 >
 <button
 @click="cerrarCompra"
 ...
 <p
 class="uppercase text-[#de3f26] font-articulat-bold tracking-widest text-sm"
 >
 Festival ESCLAT 2026
 </p>

 <h3
 class="text-[#2f1204] text-3xl uppercase font-articulat-bold mt-10 mb-8"
 >
 Compra de entradas
 </h3>
 ...
 <div
 v-else
 class="flex flex-col justify-center items-center pt-16 pb-8"
 >
 <img
 v-if="tipoEntrada === 'abono completo'"
 src="/COMPLETO.png"
 alt="Entrada completa"
 class="w-100 h-auto"
 />

 <img
 v-else-if="tipoEntrada === '1 día'"
 src="/1DIA.png"
 alt="Entrada 1 día"
 class="w-100 h-auto"
 />
 ...
 :href="imagenEntrada"
 download
 class="mt-6 bg-[#de3f26] text-[#fff3d7] px-6 py-3 uppercase font-articulat-bold"
 >
 Descargar entrada
 </a>
