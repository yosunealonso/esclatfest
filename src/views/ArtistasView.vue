      ...
      >
        ...
        >
          ...
          <div class="aspect-video w-full bg-[#1a0a02] relative overflow-hidden">
            ...
            <span class="absolute top-2 right-2 bg-[#dd2f03] group-hover:bg-[#fff3d7] text-[#fff3d7] group-hover:text-[#dd2f03] px-2 py-0.5 text-[10px] uppercase font-articulat-bold transition-colors duration-300 z-10">
              {{ artista.disciplina }}
            </span>
          </div>
          ...
          <div class="p-4 flex flex-col grow space-y-3">
            ...
            <div class="space-y-1 pt-2.5 border-t border-[#2f1204]/10 group-hover:border-[#fff3d7]/20 transition-colors duration-300">
              ...
              <ul class="space-y-0.5">
                ...
                >
                  <span class="h-1.5 w-1.5 bg-[#dd2f03] group-hover:bg-[#fff3d7] shrink-0 transition-colors duration-300"></span>
                  <span class="truncate">
                    {{ actividad }}
                  </span>
                </li>
